...
<div class="row">
		...
		<div class="col-md-3 form-horizontal" >
			...
			<div class="form-group field-content-takonomy_id">
				<label class="col-md-4 control-label no-padding-left no-padding-right align-left" for="content-takonomy_id">主分类</label>
				<div class="col-md-8">
				<select id="content-takonomy_id" class="form-control" name="Content[takonomy_id]" >
				<?php echo $options?>
				</select>
				</div>
				<div class="help-block"></div>
