...
<?php $this->beginBody() ?>
       ...
       <div class="mod-header-logo">
        ...
        <div class="mod-header-nav">
            <ul class="pull-left">
                ...
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>" target="mainFrame">首页</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">设置</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">类目</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">内容</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">模块</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">用户</a>
                </li>
                <li>
                    <a href="<?php echo LuLu::getAlias('@web');?>"  target="mainFrame">工具</a>
                </li>
                 <li>

                     <button class="btn btn-sm mod-head-btn pull-left" style="height:20px;">
    ...
    <div class="aw-side" id="aw-side">
        <div class="mod">
            ...
            <ul class="mod-bar" id="home"  style="display:none;">
                <li>
            ...
            <ul class="mod-bar" id="content" style="display:none;">
